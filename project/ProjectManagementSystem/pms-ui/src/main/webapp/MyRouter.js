...
sap.ui.core.routing.Router.extend("com.www.MyRouter", {
  ...
  _navBack : function(sViewName) {
    ...
    if (sPreviousHash !== undefined) {
      ...
      this.navTo(sViewName, true);
    }
  },

  bssNavCancel : function(sRoute, oView) {
    var oCurrentApp = this._findSplitApp(oView);
    if (oCurrentApp) {
      oCurrentApp.backDetail();
    } else {
      this._navBack(sRoute);
    }
  },
